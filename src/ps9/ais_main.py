...
def main():
    ...
    ap.add_argument("--work_dir", default="ais", help="Download staging dir.")
    ap.add_argument("--extract_dir", default="ais", help="Extraction staging dir.")
    ap.add_argument("--out_dir", default="ais", help="Output dir for cleaned per-day files.")
    ap.add_argument("--max_workers", type=int, default=4, help="Parallel workers for download/extract.")
    ap.add_argument("--save_format", choices=["parquet","csv"], default="csv")
